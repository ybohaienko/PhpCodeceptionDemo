<?php  //[STAMP] dab4a43884f77ae2153ed332c8f0298e
...
trait AcceptanceTesterActions
{
     ...
     * @see \Codeception\Module\Asserts::assertEquals()
     */
    public function tryToAssertEquals($expected, $actual, $message = null, $delta = null) {
     ...
     * @see \Codeception\Module\Asserts::assertEquals()
     */
    public function retryAssertEquals($expected, $actual, $message = null, $delta = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertNotEquals()
     */
    public function tryToAssertNotEquals($expected, $actual, $message = null, $delta = null) {
     ...
     * @see \Codeception\Module\Asserts::assertNotEquals()
     */
    public function retryAssertNotEquals($expected, $actual, $message = null, $delta = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertGreaterOrEquals()
     */
    public function tryToAssertGreaterOrEquals($expected, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertGreaterOrEquals()
     */
    public function retryAssertGreaterOrEquals($expected, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertLessOrEquals()
     */
    public function tryToAssertLessOrEquals($expected, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertLessOrEquals()
     */
    public function retryAssertLessOrEquals($expected, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertIsEmpty()
     */
    public function tryToAssertIsEmpty($actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertIsEmpty()
     */
    public function retryAssertIsEmpty($actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertArrayHasKey()
     */
    public function tryToAssertArrayHasKey($key, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertArrayHasKey()
     */
    public function retryAssertArrayHasKey($key, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertArrayNotHasKey()
     */
    public function tryToAssertArrayNotHasKey($key, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertArrayNotHasKey()
     */
    public function retryAssertArrayNotHasKey($key, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertCount()
     */
    public function tryToAssertCount($expectedCount, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertCount()
     */
    public function retryAssertCount($expectedCount, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertInstanceOf()
     */
    public function tryToAssertInstanceOf($class, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertInstanceOf()
     */
    public function retryAssertInstanceOf($class, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertNotInstanceOf()
     */
    public function tryToAssertNotInstanceOf($class, $actual, $description = null) {
     ...
     * @see \Codeception\Module\Asserts::assertNotInstanceOf()
     */
    public function retryAssertNotInstanceOf($class, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\Asserts::assertInternalType()
     */
    public function tryToAssertInternalType($type, $actual, $description = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertInternalType', func_get_args()));
    }    
    /**
     * [!] Method is generated.
     * 
     ...
     * @see \Codeception\Module\Asserts::assertInternalType()
     */
    public function retryAssertInternalType($type, $actual, $description = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertInternalType', func_get_args(), $retryNum, $retryInterval));
    }
